// components/doctors/DoctorConfirmModal.tsx
"use client";
...
export function DoctorConfirmModal({
  ...
  const title = isDeactivating ? "Desactivar Doctor" : "Activar Doctor";
  const message = isDeactivating
    ? `¿Estás seguro que deseas desactivar al doctor ${fullName}? Esta acción impedirá que pueda realizar consultas.`
    : `¿Estás seguro que deseas activar al doctor ${fullName}? Podrá volver a realizar consultas.`;
