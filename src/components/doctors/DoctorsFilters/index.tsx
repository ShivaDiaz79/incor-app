// components/doctors/DoctorsFilters.tsx
"use client";

import { useState } from "react";
import Button from "@/components/ui/button/Button";
import type { DoctorFilters } from "@/types/doctors";
...
export function DoctorsFilters({
  ...
  const hasActiveFilters = Boolean(
    filters.search || filters.speciality || filters.isActive !== undefined
  );
      ...
      <form onSubmit={handleSearchSubmit} className="flex gap-3">
        <div className="flex-1">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Buscar por nombre, especialidad, número de licencia..."
              value={searchInput}
        ...
        <div className="grid grid-cols-1 gap-4 border-t border-gray-200 pt-4 dark:border-gray-700 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                onFiltersChange({
                  speciality: e.target.value || undefined,
                })
              }
              disabled={loading}
          ...
          <div>
            ...
            >
              ...
              <option value="speciality">Especialidad</option>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                onFiltersChange({
                  sortOrder: e.target.value as DoctorFilters["sortOrder"],
                })
              }
              disabled={loading}
              className="mt-1 block w-full rounded-lg border border-gray-300 bg-white py-2 pl-3 pr-10 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:focus:border-brand-400 dark:focus:ring-brand-400"
